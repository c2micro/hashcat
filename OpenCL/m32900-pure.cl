...
KERNEL_FQ void m32900_init (KERN_ATTR_TMPS_ESALT (krb5tgt_18_tmp_t, krb5tgt_18_t))
{
  /**
   * base
   */
  ...
  sha1_hmac_update_global_swap (&sha1_hmac_ctx, esalt_bufs[DIGESTS_OFFSET_HOST].salt, esalt_bufs[DIGESTS_OFFSET_HOST].salt_len);
...
KERNEL_FQ void m32900_loop (KERN_ATTR_TMPS_ESALT (krb5tgt_18_tmp_t, krb5tgt_18_t))
{
   /**
   * base
   */
...
KERNEL_FQ void m32900_comp (KERN_ATTR_TMPS_ESALT (krb5tgt_18_tmp_t, krb5tgt_18_t))
{
  /**
   * base
   */
  ...
  */
  ...
  first_blocks[0] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[0];
  first_blocks[1] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[1];
  first_blocks[2] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[2];
  first_blocks[3] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[3];

  first_blocks[4] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[4];  // possible ASN1 structs
  first_blocks[5] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[5];
  first_blocks[6] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[6];  // possible ASN1 structs
  first_blocks[7] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[7];

  /*
     we will decrypt them here in order to be able to compute hmac directly
     if ASN1 structs were to be found
  */
  first_blocks[8]  = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[8];
  first_blocks[9]  = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[9];
  first_blocks[10] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[10];
  first_blocks[11] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[11];

  first_blocks[12] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[12];
  first_blocks[13] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[13];
  first_blocks[14] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[14];
  first_blocks[15] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[15];
  ...
  if (((decrypted_block[0] & 0xff00ffff) == 0x30008163) || ((decrypted_block[0] & 0x0000ffff) == 0x00008263))
  {
    if (((decrypted_block[2] & 0x00ffffff) == 0x00000503) || (decrypted_block[2] == 0x050307A0))
    {
      ...
      int ticket_len = esalt_bufs[DIGESTS_OFFSET_HOST].ticket_len;

      int ticket_left;

      u32 block[16];

      int last_block_size = ticket_len % 16;
      ...
      */
      ...
      for (ticket_left = need - 64; ticket_left >= 64; ticket_left -= 64)
      {
        block[0]  = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[block_position +  0];
        block[1]  = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[block_position +  1];
        block[2]  = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[block_position +  2];
        block[3]  = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[block_position +  3];
        block[4]  = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[block_position +  4];
        block[5]  = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[block_position +  5];
        block[6]  = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[block_position +  6];
        block[7]  = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[block_position +  7];
        block[8]  = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[block_position +  8];
        block[9]  = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[block_position +  9];
        block[10] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[block_position + 10];
        block[11] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[block_position + 11];
        block[12] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[block_position + 12];
        block[13] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[block_position + 13];
        block[14] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[block_position + 14];
        block[15] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[block_position + 15];
      ...
      */
      ...
      last_block_cbc[0] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[last_block_cbc_position + 0];
      last_block_cbc[1] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[last_block_cbc_position + 1];
      last_block_cbc[2] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[last_block_cbc_position + 2];
      last_block_cbc[3] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[last_block_cbc_position + 3];
      ...
      int last_block_position = (ticket_len - last_block_size) / 4;
      ...
      */
      ...
      switch (remaining_blocks)
      {
        case 0:
          ...
          last_block[0] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[last_block_position + 0];
        ...
        case 1:
          ...
          {
            last_block[1] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[last_block_position + 1];
        ...
        case 2:
          ...
          {
            last_block[2] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[last_block_position + 2];
        ...
        case 3:
          ...
          {
            last_block[3] = esalt_bufs[DIGESTS_OFFSET_HOST].ticket[last_block_position + 3];
